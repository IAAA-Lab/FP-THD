...
def get_args_parser():
    parser = argparse.ArgumentParser(description='HTR for HTR',
                                     add_help=True,
    ...
    IAM.add_argument('--test-data-list', type=str, default='./data/iam/test.ln',
                     help='test data list')
    IAM.add_argument('--nb-cls', default=211, type=int, help='fi 3oudh 80 7atit 208 lel pero layout, nb of classes, IAM=79+1, READ2016=89+1')
    ...
    READ.add_argument('--test-data-list', type=str, default='./data/read2016/test.ln',
                      help='test data list')
    READ.add_argument('--nb-cls', default=107, type=int, help=' nb of classes, IAM=79+1, READ2016=89+1')
    ...
    LAM.add_argument('--test-data-list', type=str, default='./data/LAM/test.ln',
                     help='test data list')
    LAM.add_argument('--nb-cls', default=248, type=int, help='asli 90 lam nb of classes, IAM=79+1, READ2016=89+1')

    MDM = subparsers.add_parser("MDM",
                                description='Dataset parser for training on MDM',
                                add_help=True,
                                formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                help="Dataset parser for training on MDM")

    MDM.add_argument('--train-data-list', type=str, default='./data/MDM/train.ln',
                     help='train data list (gc file)(ln file)')
    MDM.add_argument('--data-path', type=str, default='./data/MDM/lines/',
                     help='train data list')
    MDM.add_argument('--val-data-list', type=str, default='./data/MDM/val.ln',
                     help='val data list')
    MDM.add_argument('--test-data-list', type=str, default='./data/MDM/test.ln',
                     help='test data list')
    MDM.add_argument('--nb-cls', default=90, type=int, help='nb of classes for MDM')
