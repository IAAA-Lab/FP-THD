...
def get_args_parser():
    ...
    IAM.add_argument('--test-data-list', type=str, default='./data/iam/test.ln',
                     help='test data list')
    IAM.add_argument('--nb-cls', default=211, type=int, help='nb of classes, IAM=79+1, READ2016=89+1')
    ...
    READ.add_argument('--test-data-list', type=str, default='./data/read2016/test.ln',
                      help='test data list')
    READ.add_argument('--nb-cls', default=107, type=int, help='fi 3oudh 90nb of classes, IAM=79+1, READ2016=89+1')
    ...
    LAM.add_argument('--test-data-list', type=str, default='./data/LAM/test.ln',
                     help='test data list')
    LAM.add_argument('--nb-cls', default=126, type=int, help='migeulcorrecttrain pages 85 benthman 94 mdmdsinJ 129 mdmpero 248, 252 bedelt 90 b nombre nb of classes, IAM=79+1, READ2016=89+1')
